function [ xcorrs ] = get_corcoef_fft( shortVec, longVec, shortVecBit, longVecBit )
    % get_cc_fft
...
%     
    import CA.CombAuc.Core.Comparison.corcoef_fft;
    [xx1, xx2] = corcoef_fft(zscore(shortVecCut), longVec);
