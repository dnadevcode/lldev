classdef settings_thresh < handle
    % updated 11/04/17
    % Settings
    ...
    properties
        contigSizeAllPos = 24000:1000:60000;
        lengthBarcode = 232;
        uncReg  = 3347;
        psfSigmaWidth = 1.1157e+03;
        kbpPerPixel = 3.719*159.2; %bpPerNm*camRes
        shiftBp = 20000;
        pValueThresh = 0.01;
        contigLen = 50000;
        dist = 3;
...
%         
    ...
    methods
        function settings_thresh = settings_thresh(isDefault)
            % Constructor. 
%             if nargin == 0
%                 isDefault = true;
%                 refCurve = [];
...
%             end
            settings_thresh.calc_constants();
        end
