function [lm] = launch_kymo_import_ui(hPanelKymoImport, tsHCA)
    ...
    flmbs1.add_button(make_add_kymos_from_dbm_btn(tsHCA));
    flmbs1.add_button(make_add_kymos_directly_btn(tsHCA));
    ...
    function [btnAddKymos] = make_add_kymos_directly_btn(ts)
        ...
        function [] = on_add_kymos_directly(lm, ts)
            ...
            import  import Fancy.UI.Templates.extract_kymos_structs;
            kymoStructs = extract_kymos_structs(rawKymos, rawKymoFilepaths);
