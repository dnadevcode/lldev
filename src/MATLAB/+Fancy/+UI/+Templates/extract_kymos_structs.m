function [ kymoStructs ] = extract_kymos_structs(rawKymos, rawKymoFilepaths, pixelsWidths_bps,alignedKymos,alignedKymosStretchFactors,shiftAlignedKymos)
   % extract_kymos_structs
   
   % extracts kymo structure from a file path, or alternatively kymograph
   % is given as an input. Seems we can reduce this quite a lot possibly..
