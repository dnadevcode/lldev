function [] = generate_ete_ui_bitmasked(ts, eteSessionStruct)
    % generate_ete_ui_bitmasked
    
    % save variables from eteSessionStruct as variables in the session
    ...
    import CBT.ExpComparison.UI.plot_exp_vs_exp_barcodes_bitmasked;
    set(hBtnPlotBarcodes, 'Callback', @(~, ~) ...
            feval(@(barcodeIdxA, barcodeIdxB) ...
               CBT.ExpComparison.UI.plot_exp_vs_exp_barcodes_bitmasked( ...
                    hAxis, ...
                    barcodeIdxA, ...
                    barcodeIdxB, ...
                    comparisonResults, ...
