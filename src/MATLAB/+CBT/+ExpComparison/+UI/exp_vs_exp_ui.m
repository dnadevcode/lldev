function [] = exp_vs_exp_ui(...
    ...
    import CBT.ExpComparison.Core.compare_exps_to_exps;
    [...
        pValMat, ...
        maxPCCsMat, ...
        flipMat, ...
    ...
    eteSessionStruct = create_ete_session_struct(...
            stretchedConsensusBarcodes, ...
            isPlasmid, ...
            stretchedKbpsPerPixel, ...
            sameLengthTF, ...
    ...
    generate_ete_ui(ts, eteSessionStruct);
