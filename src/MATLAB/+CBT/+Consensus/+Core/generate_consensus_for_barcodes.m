...
%     %% main fun to generate consensus
%     tic
    import CBT.Consensus.Core.generate_consensus_maxscore;
    [consensusStructs] = generate_consensus_maxscore( ...
    consensusInputs.barcodes, ...
    consensusInputs.bitmasks );
%     toc

    import CBT.Consensus.Export.export_cbc_compatible_consensus;
    [consensusStruct] = export_cbc_compatible_consensus( consensusStructs, consensusInputs,rawBarcodes,barcodeConsensusSettings);

%     
%     sets.consensus.threshold = barcodeConsensusSettings.clusterScoreThresholdNormalized;
%     % now select the best
%     import CBT.Consensus.Core.select_consensus;
%     [ consensus,sets] = select_consensus( consensusStructs, sets );
%   
%     
%     import CBT.Consensus.Export.export_cbc_compatible_consensus;
%     export_cbc_compatible_consensus(consensusStructs);
