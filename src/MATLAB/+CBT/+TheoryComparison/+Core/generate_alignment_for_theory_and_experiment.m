function [alignedThyCurve, alignedExperimentCurve,...
        ...
        = generate_alignment_for_theory_and_experiment(theoryStruct, experimentStruct, stretchFactor, constantSettingsStruct)
    ...
    thyCurve_bpRes = get_struct_theory_curve_bpRes(theoryStruct);
