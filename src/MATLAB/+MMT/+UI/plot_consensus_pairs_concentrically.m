function [] = plot_consensus_pairs_concentrically(clusterConsensusData)
    ...
    for pairingNum=1:numPairings
        ...
        [hCurrPairingTab, hCurrPairingTabNum] = ts.create_tab(tabTitle);
        ts.select_tab(hCurrPairingTabNum);
    ...
    [hConsensusTab, hConsensusTabNum] = ts.create_tab(tabTitle);
    ts.select_tab(hConsensusTabNum);
