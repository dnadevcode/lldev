classdef NtSeqImportScreen < handle
    ...
    methods
        function [nsis] = NtSeqImportScreen(ts)
            ...
            [hNtSeqImportPanel, hNtSeqImportTab, ntSeqImportTabNum] = NtSeqImportScreen.make_import_panel_in_new_tab(ts, tabTitle, deleteFcn);
            ts.select_tab(ntSeqImportTabNum);
        ...
        function [] = add_nt_seq_filepaths(nsis, additionalSeqFilepaths)
            ...
            import AppMgr.ImportItemContext;
            import AppMgr.AppDataPoolMgr;
            import NtSeq.UI.NtSeqImportScreen;
            if any(newItemsMask)
        ...
        function [] = sync_ui_list_data(nsis)
            ...
            import AppMgr.ImportItemContext;
            import FancyUtils.FancyStrUtils.make_unique_filepath_display_names;
    ...
    methods(Static, Access = private)
        ...
        function [hNtSeqImportPanel, hNtSeqImportTab, ntSeqImportTabNum] = make_import_panel_in_new_tab(ts, tabTitle, deleteFcn)
            
            [hNtSeqImportTab, ntSeqImportTabNum] = ts.create_tab(tabTitle, deleteFcn);
