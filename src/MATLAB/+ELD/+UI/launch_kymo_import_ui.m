function [lm] = launch_kymo_import_ui(hPanelKymoImport, tsELD)
    ...
    flmbs1.add_button(make_add_kymos_from_dbm_btn(tsELD));
    flmbs1.add_button(make_add_kymos_directly_btn(tsELD));
    ...
    function [btnAddKymos] = make_add_kymos_directly_btn(ts)
        ...
        function [] = on_add_kymos_directly(lm, ts)
            ...
            set_raw_kymo_data(dbmODW, rawKymos, rawKymoFilepaths);
