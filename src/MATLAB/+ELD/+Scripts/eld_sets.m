function [ sets ] = eld_sets()
  ...
  %  sets.moviefilefold{1} = 'example/';
    ...
    sets.thrfilenames{1} = 'sequenceDot.fasta';
    sets.thrfilefold{1} = '/home/albyback/git/Projects/ELD/';
    addpath(genpath(sets.thrfilefold{1} ));
%         
...
%     addpath(genpath(sets.kymoFold));
    ...
    % channel extraction 
    sets.channelDetection.channelWidthPx = 4; % do some robustness analysis
