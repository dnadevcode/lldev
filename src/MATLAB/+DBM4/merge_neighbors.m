function [outputArg1,outputArg2] = merge_neighbors(barcodeGen,minOverlap)

minOverlap = 300;


% potential neighbors are defined by -1,-2,-3,-N flag. Read these of from
% names
...
% bars which appear more than once
