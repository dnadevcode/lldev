...
% timestamp = datestr(clock(), 'yyyy-mm-dd_HH_MM_SS');
%     save(fullfile(dbmStruct.rawMovieDirPath,['dbmStruct_recalc',timestamp,'.mat']),'DBMMainstruct','DBMSettingsstruct','kymoStructs')
%     disp(['Data saved at ',dbmStruct.rawMovieDirPath ])
% 
